    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            with gr.Row(
                ...
                with gr.Tabs(
                    ...
                    with gr.Tab(
                        label="Upscale or Variation", id="uov_tab", visible=False
                    ) as uov_tab:
                        with gr.Row():
                            with gr.Column():
                        ...
                        with gr.Tab(
                            label="Image Prompt", id="ip_tab", visible=False
                        ) as ip_tab:
                            with gr.Row():
                                ip_images = []
                                ip_types = []
                    ...
                    with gr.Tab(
                        label="Describe", id="describe_tab", visible=False
                    ) as describe_tab:
                        with gr.Row():
                            with gr.Column():
                    ...
                    with gr.Tab(
                        label="Enhance", id="enhance_tab", visible=False
                    ) as enhance_tab:
                        with gr.Row():
                            with gr.Column():
                    ...
                    with gr.Tab(
                        label="Metadata", id="metadata_tab", visible=False
                    ) as metadata_tab:
                        with gr.Column():
        ...
        if not args_manager.args.disable_preset_selection:
            ...
            preset_selection.change(
                ...
                queue=False,
                show_progress=False,
            ).then(lambda: None, _js="()=>{refresh_style_localization();}").then(
        ...
        describe_btn.click(
            trigger_describe,
            inputs=[describe_method, describe_input_image],
        ...
        if args_manager.args.enable_auto_describe_image:
            ...
            uov_input_image.upload(
                ...
                inputs=[describe_method, uov_input_image, prompt],
                outputs=[prompt, style_selections],
                show_progress=True,
                queue=True,
            )
            ...
            enhance_input_image.upload(
                ...
                trigger_auto_describe,
                inputs=[describe_method, enhance_input_image, prompt],
                outputs=[prompt, style_selections],
                show_progress=True,
                queue=True,
            )
