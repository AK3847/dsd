                ...
                for line in fp:
                    ...
                    for filepath, hash_value in entry.items():
                        if (
                            ...
                            and len(hash_value) != HASH_SHA256_LENGTH
                        ):
...
def init_cache(model_filenames, paths_checkpoints, lora_filenames, paths_loras):
    ...
    if args_manager.args.rebuild_hash_cache:
        max_workers = (
            ...
            if args_manager.args.rebuild_hash_cache > 0
            else cpu_count()
        )
        rebuild_cache(
            lora_filenames, model_filenames, paths_checkpoints, paths_loras, max_workers
        )
